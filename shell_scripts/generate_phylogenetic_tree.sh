# This shell script generates unrooted and rooted newick phylogenetic trees using MAFFT and Fasttree. Runs MAFFT for alignment, masks alignment, constructs an unrooted phylogenetic tree using Fasttree, and roots the tree based on the median point. Uses a qiime2 tutorial on building phylogenetic trees.
